...
| **Accessibilité RGAA** — déclaration « non conforme » (ce qu'elle veut dire), audit du 27 août 2026, **schéma pluriannuel 2026-2029** et plan d'action publiés dans l'app ; ⚠️ un contrôle axe lancé trop tôt mesure un écran **encore invisible** et ne peut pas échouer | `docs/accessibilite/audit-rgaa-2026-08-27.md` et `docs/accessibilite/schema-pluriannuel.md`, puis `docs/adr/0030-axe-mesure-un-ecran-encore-invisible.md` |
