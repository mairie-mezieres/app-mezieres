...
| **La mémoire d'une veille ne s'écrit jamais dans le prompt** — l'agent produit un JSON, un script écrit le Markdown ; sinon l'étape est sautée en silence et la veille se répète | `docs/adr/0026-veille-municipale-la-memoire-est-ecrite-par-du-code.md` |
