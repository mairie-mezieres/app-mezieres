...
| **Accessibilité RGAA** — audit **complet** (106 critères, aucun sans verdict, **98,5 %** en v4.96), **schéma pluriannuel 2026-2029** et plan d'action publiés dans l'app, **1 non-conformité** restante (10.5 ; 3.2 levé en v4.96) ; ⚠️ un contrôle qui ne mesure rien **ne rougit pas, il verdit** (axe sur un écran encore invisible ; repère de JSON introuvable dans `validite-html.yml`) | `docs/accessibilite/audit-rgaa-2026-08-27.md` et `docs/accessibilite/schema-pluriannuel.md`, puis `docs/adr/0030-axe-mesure-un-ecran-encore-invisible.md` |
