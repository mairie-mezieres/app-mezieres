...
| **Veille municipale (élus)** — subventions et obligations, profil `veille/commune.yml` (⚠️ **connaissance, pas mise en forme**), mémoire + fenêtre `J-35`, envoi test → conseil par secret | `docs/adr/0025-veille-municipale-memoire-et-fenetre-de-publication.md` puis `docs/guide-technique.md` §10 et `veille/README.md` |
