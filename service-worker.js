...
const CRITICAL_PRECACHE = [
  ...
  './js/mat-utils.js?v=4.3.4',
  './js/mat-core.js?v=4.3.1'
];
...
const PRECACHE_URLS = [
  ...
  './js/mat-widgets.js?v=4.4.6',
  './js/mat-ambiance.js?v=1.2.0',
  ...
  './js/mat-boot.js?v=4.3.5',
  './js/mat-pwa-notif.js?v=4.2.7',
