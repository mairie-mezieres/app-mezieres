...
> deux tuiles et le hero de la mise en page bureau. Le critère n'est pas levé pour
> autant — deux thèmes optionnels restent en défaut — mais ce que voit un habitant
...
| 2 bis | **Ce qui pouvait être anticipé l'a été** (v4.103, 1er septembre 2026) | Le RGAA 5 intégrera les **WCAG 2.2**, publiées depuis 2023 : leurs deux nouveaux critères mécaniquement mesurables ont été traités — **2.5.8** (9 cibles agrandies à 24 px sans que le libellé bouge) et **2.4.11** (un bandeau qui recouvrait le bouton « Installer »). Deux contrôles de non-régression, sabotés avant d'être retenus — et le premier a dû être **rendu déterministe** avant de valoir quelque chose : il concluait au vert ou au rouge selon l'état de la page. | fait |
| 2 ter | **Documents bureautiques** — le seul chantier réel qu'ouvrira le RGAA 5 | La nouvelle version étendra le périmètre aux PDF publiés (PLUi, comptes rendus de conseil). Ils ne sont pas produits par l'application : leur accessibilité relève de la chaîne de production de la mairie et de la Communauté de Communes. À instruire sur le texte réel, pas par anticipation. | à la parution |
