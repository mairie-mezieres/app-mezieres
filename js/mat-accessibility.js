...
const OB_FEATURES = [
  ...
  { ico:'🚌', title:`Bus & Carburant`, desc:`Horaires en temps réel du bus Rémi ligne 8, et prix des carburants SP95 et Diesel dans les stations locales.`, sel:'.bus-strip.bus-half', selDesktop:'#dsk-bus' },
  ...
  { ico:'🎭', title:`Sorties locales`, desc:`Randonnées pédestres autour de Mézières et événements culturels dans un rayon de 20 km : concerts, expos, marchés, fêtes de village.`, sel:'button[onclick="openEventsLocaux()"]', selDesktop:'.d-rando-banner' },
