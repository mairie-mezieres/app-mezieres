...
/* ════════════════════════════════════════════════════════════
   ...
   ⚠️ Les PR Dependabot de ce dépôt portent sur `tests/e2e/package.json` (Playwright
   et ses pairs) : elles ne touchent RIEN de ce qui est servi aux habitants. Le
   contrôle des fichiers le vérifie quand même, plutôt que de le supposer.
...
const { TOKEN, REPO, DRY_RUN, gh, ghListe, resume, etatCI, pastille } = require('./lib/veille-suivi');
